...
const LikelihoodBar = ({filtering=true}) => {
...
useEffect(() => {
  ...
  return (
    <div className="p-4">
      <Header title="LIKELIHOOD BAR CHART" subtitle="Filter & explore insights" />
      ...
      <BarChart data={filteredData} xField={selectedXAxis} theme="Likelihood" chart="likelihood" />
    </div>
  );
};
