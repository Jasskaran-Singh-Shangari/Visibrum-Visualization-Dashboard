...
const RelevanceBar = ({filtering=true}) => {
...
useEffect(() => {
  ...
  return (
    <div className="p-4">
      <Header title="RELEVANCE BAR CHART" subtitle="Filter & explore insights" />
      ...
      <BarChart data={filteredData} xField={selectedXAxis} theme="Relevance" chart="relevance" />
    </div>
  );
};
